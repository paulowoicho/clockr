# Employee Time Tracking App based on React Native Firebase Starter

Very Simple application that automatically clocks an employee in and out at your business locations
...
- 1.1) `git clone https://github.com/paulowoicho/clockr.git`
- 1.2) `cd clockr` - cd into your newly created project directory.
